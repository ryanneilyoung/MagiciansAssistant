	  	...
	  	<div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navBar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="magicianClientList.jsp">Manage Client List</a></li>
					...
					<li><a href="newClient.jsp">Register New Client</a></li>
				</ul>
			</div>
		</div>
	</nav>
...
<div class="container">
	<%=MagicianController.getClientListTable((Integer) session.getAttribute("id")) %>
	${param.message}
</div>
