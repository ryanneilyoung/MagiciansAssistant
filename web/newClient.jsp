	  	...
	  	<div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navBar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="newClient.jsp">Register New Client</a>
				</ul>
			</div>
		</div>
	</nav>
...
<div class="container">
    <h2>Register a New Client</h2><br>
	<form class="form-horizontal" action="NewClientExchange" Method="post">
