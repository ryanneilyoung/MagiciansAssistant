...
<div class="container">
		...
		<H1 style="margin-left: 15%;">Change Account Name</H1>
		<hr style="height:1px;border:none;color:#d3d3d3;background-color:#d3d3d3;">
		<fieldset>
		<input type="hidden" name="enter" value="Save Name" style="display: none;">
			<div class="form-group row"> 	
				<label class="col-md-4 control-label" for="magicianName" align="right">Enter New Name: </label>
				<div class="col-md-5">
					<input type="text" name="magicianName" id="magicianName" class="form-control input-md">
				</div>
			</div>
			
			<div class="form-group row"> 
				<label class="col-md-4 control-label" for="magicianNameConfirm">Re-Enter New Name: </label>
				<div class="col-md-5">
					<input type="text" name="magicianNameConfirm" id="magicianNameConfirm" class="form-control input-md">
				</div>
			</div>
			<br>
			<div class="form-group row col-md-4"> 
				<input type="submit" name="enter" value="Save Name" id="saveName" class="btn btn-default">
			</div> 
			</fieldset>
		</form>  
</div>
...
$("#accountForm").submit(function(event){
	...
	var name = document.getElementById("magicianName").value;
    var nameConfirm = document.getElementById("magicianNameConfirm").value;
    ...
    else if(name !== nameConfirm)
    {
		alert("Names must Match");
		return false;
    }
    else
    {
    	...
    	bootbox.confirm({
    	    title: "Change name?",
    	    message: "Changing name will alter your name on all pages. Would you like to continue?",
    	    buttons: {
    	        cancel: {
